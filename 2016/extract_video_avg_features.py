...
class MSRVTTSequence(Sequence):
	def __init__(self, captions_dict, video_folder,fps_dict, batch_size):
...
# Create generator
all_videos_generator = MSRVTTSequence(sorted_captions, video_folder=videos_folder, fps_dict=video_fps, batch_size=4)
